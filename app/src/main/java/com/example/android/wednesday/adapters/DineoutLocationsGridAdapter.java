...
public class DineoutLocationsGridAdapter extends RecyclerView.Adapter<DineoutLocationsGridAdapter.DineoutCategoryViewHolder> {
    ...
    public DineoutLocationsGridAdapter(Context context, List<CategoryModel> dataSource){
    ...
    @Override
    public DineoutLocationsGridAdapter.DineoutCategoryViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
