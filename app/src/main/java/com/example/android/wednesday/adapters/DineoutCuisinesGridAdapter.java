...
public class DineoutCuisinesGridAdapter extends RecyclerView.Adapter<DineoutCuisinesGridAdapter.DineoutCategoryViewHolder> {
    ...
    public DineoutCuisinesGridAdapter(Context context, List<CategoryModel> dataSource){
    ...
    @Override
    public DineoutCuisinesGridAdapter.DineoutCategoryViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
