...
/**
 * Created by hp pc on 2/2/2017.
 */

public class DineoutCollectionsGridAdapter extends RecyclerView.Adapter<DineoutCollectionsGridAdapter.DineoutCategoryViewHolder> {
    ...
    public DineoutCollectionsGridAdapter(Context context, List<CategoryModel> dataSource){
    ...
    @Override
    public DineoutCollectionsGridAdapter.DineoutCategoryViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
